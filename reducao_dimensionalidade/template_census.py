...
# OneHotEnconder é utilizado para variáveis categóricas nominais para quantitativa discreta, onde cada valor do atributo GERA NOVAS COLUNAS E POSSUEM VALORES DE 0 OU 1,
